...
class ArtConverter:
    def __init__(self, path='video/Rick_Roll.mp4', font_size=12, color_lvl=8):
        pg.init()
        self.path = path
        ...
        self.record = False
        self.recorder = cv2.VideoWriter('output/ascii_color.mp4', cv2.VideoWriter_fourcc(*'mp4v'), self.rec_fps, self.RES)
